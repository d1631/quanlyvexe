            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Thêm tuyến xe</h1>
                       
                        <form:form method="post" action="addTx" modelAttribute="tuyenxe" >
                            <div class="row">
                                <div class="col-md-6" id="ips">
                                    <label>điểm đầu</label>
                                    <form:input type="text" class="form-control" placeholder="điểm đầu(tỉnh)" path="diemdau" />
                                    <form:input type="hidden" path="id" />
                                </div>
                                <div class="col-md-6" id="ips">
                                    <label>điểm cuối</label>
                                    <form:input type="text" class="form-control" placeholder="điểm cuối(tỉnh)" path="diemcuoi" />
                                </div>
                                <div class="col-md-6" id="ips">
                                    <label>giá vé</label>
                                    <form:input type="number" class="form-control" placeholder="giá vé" path="giatien"/>
                                </div>
                                <div class="col-md-6" id="ips">
                                    <label>biển số</label>
                                    <form:input type="text" class="form-control" placeholder="30A-92178" path="bienso" />
                                </div>
                                <div class="col-md-6" id="ips">
                                    <label>giờ khởi hành</label>
                                    <form:input type="time" class="form-control" path="giokhoihanh" />
                                </div>
                                 <div class="col-md-6" id="ips">
                                    <label>giờ về</label>
                                ...
                                <div class="col-md-6" id="ips">
                                    <label>các chặng đi qua</label>
                                    <form:textarea placeholder="các xã, huyện" class="form-control" path="cacChangQua"></form:textarea>
                                </div>
                                <div class="col-md-12" id="ips">
                                    <button class="btn-success form-control">Thêm tuyến xe</button>
                                </div>
                            </div>
                        </form:form>
