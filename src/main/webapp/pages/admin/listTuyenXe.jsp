                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listTuyenXe}" var="list">
                                        <tr>
                                            <td>${list.id}</td>
                                            <td>${list.diemdau}</td>
                                            <td>${list.diemcuoi}</td>
                                            ...
                                            <td>${list.giatien}</td>
                                            <td>${list.bienso}</td>
                                            <td>${list.giokhoihanh}</td>
                                            <td>${list.giove}</td>
                                            <td>
                                                <a href="../admin/deleteTuyenxe?id=${list.id}"><i class="fa fa-trash"></i> xóa</a>
                                                <br>
                                                <a href="../admin/addTuyenxe?id=${list.id}"><i class="fa fa-edit"></i> cập nhật</a>
                                            </td>
                                        </tr>
                                       </c:forEach>
                                    </tbody>
