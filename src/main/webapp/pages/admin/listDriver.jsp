            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Danh sách tài xế</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listDriver}" var="list">
                                        <tr>
                                            <td>${list.id}</td>
                                            <td>${list.fullname}</td>
                                            <td>${list.username}</td>
                                            <td>${list.phone}</td>
                                            <td><img src="${list.avatar}" style="width: 100px;"></td>
                                            <td>
                                                <a href="deleteDriver?id=${list.id}"><i class="fa fa-trash"></i> xóa</a>
                                                <br>
                                                <a href="addDriver?id=${list.id}"><i class="fa fa-edit"></i> cập nhật</a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
