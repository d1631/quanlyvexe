            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Danh sách chuyến xe</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <c:forEach items="${listChuyenXe}" var="list">
                                        <tr>
                                            ...
                                            <td>${list.tuyenxe.diemdau}-${list.tuyenxe.diemcuoi}</td>
                                            <td>${list.ngaydi}</td>
                                            <td>${list.giodi}</td>
                                            <td>${list.giove}</td>
                                            <td>${list.price}</td>
                                            <td>${list.tuyenxe.cacChangQua}</td>
                                            <td>
                                                <a href="../admin/deleteChuyenxe?id=${list.id}"><i class="fa fa-trash"></i> xóa</a>
                                                <br>
                                                <a href="../admin/addChuyenxe?id=${list.id}"><i class="fa fa-edit"></i> cập nhật</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
