            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Thêm tài xế</h1>
                       
                        <form:form method="post" action="addDriver" enctype="multipart/form-data" modelAttribute="driver">
                            <div class="row">
                                <div class="col-md-6" id="ips">
                                    <label>họ tên</label>
                                    <form:input type="text" class="form-control" placeholder="họ tên" path="fullname" />
                                    <form:input type="hidden" class="form-control" placeholder="họ tên" path="id" />
                                    <form:input type="hidden" class="form-control" placeholder="họ tên" path="avatar" />
                                </div>
                                <div class="col-md-6" id="ips">
                                ...
                                <div class="col-md-6" id="ips">
                                    ...
                                    <form:input type="password" class="form-control" placeholder="password" value="123" path="password" />
                                </div>
                                <div class="col-md-6" id="ips">
                                    <label>Avatar</label>
                                    <input type="file" id="choosefile" name="file" class="form-control" >
                                </div>
                                 <div class="col-md-6" id="ips">
                                     <img id="blah" alt="" src="${driver.avatar}" style="width: 200px; max-height: 200px;" />
                                </div>
                                <div class="col-md-12" id="ips">
                                    <button class="btn-success form-control">Thêm/cập nhật tài xế</button>
                                </div>
                            </div>
                        </form:form>
