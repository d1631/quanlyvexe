            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form:form method="post" action="addEmp" enctype="multipart/form-data" modelAttribute="employee">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="ips">
                                 ...
                                 <div class="col-md-6" id="ips">
                                     <img id="blah" alt="" src="${employee.avatar}" style="width: 200px; max-height: 200px;" />
                                </div>
                                <div class="col-md-12" id="ips">
                                    <button class="btn-success form-control">Thêm/cập nhật nhân viên</button>
                                </div>
                            </div>
                        </form:form>
